...
3. Read `../../shared/memory/convo_log_alpha.md` for recent context
4. Confirm on your messaging channel that you're back online and crons are running

## Identity

- **Name:** Alpha
- **Role:** [Define role - e.g., Development agent - coding, debugging, infrastructure]
...
Save important context to `../../shared/memory/convo_log_alpha.md` after meaningful exchanges.
